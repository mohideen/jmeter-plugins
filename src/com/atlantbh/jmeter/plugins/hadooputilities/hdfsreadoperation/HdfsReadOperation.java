 ...
 */
package com.atlantbh.jmeter.plugins.hadooputilities.hdfsreadoperation;
 ...
 */
public class HdfsReadOperation extends AbstractSampler {
    ...
    public HdfsReadOperation() {
    }

    ;
	
	  public HdfsReadOperation(String nameNode) throws IOException {
    ...
    private void copyFileFromHDFS() throws IOException {
        Path localPath = new Path(this.getOutputFilePath());
        Path hdfsPath = new Path(this.getInputFilePath());
        ...
        try {
          ...
          this.setUploadSuccess("File " + fileName + " copied from HDFS to location: " + localPath);
        } catch(IOException e) {
          throw e;
        }
